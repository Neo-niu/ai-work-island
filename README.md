...
2. Unzip it and move **AI工作岛.app** to **Applications**.
3. Try to open it once.
4. If macOS blocks it, open **System Settings → Privacy & Security**, verify that the blocked app is **AI工作岛**, then choose **Open Anyway**.
...
The build is written to `dist/AI工作岛.app` and the verification script installs a runnable copy in `/Applications`.
