...
struct FloatingCapsuleSnapshotTests {
    ...
    @Test func twentyCriticalCapsuleStates() throws {
        let cases: [(String, () -> FloatingStatusButtonView)] = [
            ...
            ("11-company-configured", { self.makeQuotaView(companyUsed: 50, companyTotal: 200, page: 1) }),
            ("12-company-low", { self.makeQuotaView(companyUsed: 180, companyTotal: 200, page: 1) }),
